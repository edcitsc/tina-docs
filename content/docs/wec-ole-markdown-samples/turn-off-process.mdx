...
last_edited: '2026-06-15T21:00:16.876Z'
...
> Note: If customer mentions the customer of record is deceased, refer to [Customer of Record is Deceased](/OLEV2/Pages/Customer-of-Record-is-Deceased.aspx).

> Note: MERC, MGU, NSG, PGL, and WPS only: There is no limit to the number of accounts that can be handled on a call. It is the goal to resolve all customer inquiries during the first contact. However, if the customer has six or more [Turn On](/OLEV2/Pages/OleV2-Index.aspx?guid=fedc1c66-d29c-4f51-b3b7-9a8d93d941ff\&pn=Start%20Service) or [Turn Off](/OLEV2/Pages/Turn%20Off.aspx) requests, advise the customer that the process time for the requests will be lengthy. Offer the option of using the company's website or e-mail. Refer to [Handle Multiple Accounts](/OLEV2/Pages/Handle-Multiple-Accounts.aspx).
...
Yes. A Turn Off can be requested by the customer of record, authorized spouse responsible on the bill (Y, Y), authorized party per customer notification (Y, Y), or a requester with Power of Attorney or domiciliary papers. Refer to [Customer Confidentiality - Related Contract Customer](/OLEV2/Pages/customer-confidentiality.aspx).
...
> Note: If customers request the status of a scheduled appointment or missed appointment, refer to [Verify Appointment Status](/OLEV2/Pages/Verify-Appointment-Status.aspx).

<guidedStep stepNumber={1} section="merc-mgu" headingLevel="h4" />

Access the account and confirm the request can be handled as a standard Turn Off.

1. [Locate a Contract](./locate-a-contract.md).
2. Verify the caller is authorized. Refer to [Verification Guidelines](/OLEV2/Pages/verification-guidelines.aspx).
3. If the customer is requesting demolition or tear-down service, refer to [Demolition](/OLEV2/Pages/Demolition-MERC-and-MGU.aspx).
...
6. If LVGT, transfer the call to the [Account Manager](/OLEV2/Pages/Managed-Accounts.aspx) and exit the procedure.
7. If not LVGT, continue.

<guidedStep stepNumber={2} section="merc-mgu" headingLevel="h4" />

Review special handling items.

* If the property is in foreclosure or there is mention of a Sheriff's Sale, refer to [Foreclosure Information](/OLEV2/Pages/foreclosure-information.aspx).
* If the account is on [Summary Billing](/OLEV2/Pages/Summary-Billing.aspx), remove member contracts from the group and update the mailing address through Quick Launch during the Turn Off order.

<guidedStep stepNumber={3} section="merc-mgu" headingLevel="h4" />

Determine whether there is an owner agreement at the premise.

1. [Locate an Owner Agreement](/OLEV2/Pages/Locate-an-Owner-Agreement.aspx).
...
3. If an owner agreement exists:
   ...
   * If the owner-agreement information is correct, check [Owner Agreement Rules](/OLEV2/Pages/owner-agreement-rules.aspx) to verify whether the landlord must be contacted, then continue to [Step 5](#merc-mgu-step-5).
   * If the requester is the owner and is selling the property, [delete the owner agreement](/OLEV2/Pages/Delete-an-Owner-Agreement.aspx), then continue to [Step 4](#merc-mgu-step-4).
...
<guidedStep stepNumber={4} section="merc-mgu" headingLevel="h4" />

Determine who will be responsible for service.

1. Ask for landlord or new owner information.
2. [Add or Update Landlord Information](/OLEV2/Pages/Add-or-Update-Landlord-Information.aspx) to document the details obtained.

<guidedStep stepNumber={5} section="merc-mgu" headingLevel="h4" />
...
* If a Turn On is scheduled after the requested Turn Off date and is within 2 days of the current date:
  ...
  * Enter the customer's final bill address. Refer to [Add a Mailing Address](/OLEV2/Pages/Add-a-Mailing-Address.aspx).
  * Add a [Contract Note](/OLEV2/Pages/Add-a-Note.aspx):
    * Type: Order
    * Sub type: ON/OFF
...
<guidedStep stepNumber={6} section="merc-mgu" headingLevel="h4" />
...
* If meter lock or seal is required and there is no Turn On pending, or the Turn On is more than 2 days after the requested Turn Off date:
  * Discuss all [Seal Meter Precautions and Rules](/OLEV2/Pages/Seal-Meter-Documentation.aspx).
...
* Inform the customer about [charges for reconnect](/OLEV2/Pages/charges-for-specific-services.aspx) and back billing of customer service charges if service is reconnected in the same name within one year of the seal date.
* Add a [Note](/OLEV2/Pages/add-a-note.aspx) with [Seal Meter Documentation](/OLEV2/Pages/seal-meter-documentation.aspx).
...
* If the meter is locked because of a structure fire:
  ...
  * If confirmed, refer to [Backdated Turn Off or Turn On](/OLEV2/Pages/Backdated-Turn-On-or-Turn-Off.aspx).
...
<guidedStep stepNumber={7} section="merc-mgu" headingLevel="h4" />
...
5. If backdated, refer to [Backdated Turn Off or Turn On](/OLEV2/Pages/Backdated-Turn-On-or-Turn-Off.aspx).
...
7. If a field visit is required, [Schedule an Order](/OLEV2/Pages/Schedule-an-Order.aspx).
...
10. Enter Instructions.
    ...
    Note: Refer to [Seal Meter Documentation](/OLEV2/Pages/seal-meter-documentation.aspx) when meter will be locked or sealed.
11. Update Order Attributes as applicable:
    * Advised of Reconnection Charges
    * Premise Occupied
    * Premise Winterized
12. From Quick Launch:
    * Select Address Maintenance to [Add a Mailing Address](/OLEV2/Pages/add-a-mailing-address.aspx).
...
14. If the customer also needs a Turn On and it has not been issued, use [Transfer from Turn Off/On window](/OLEV2/Pages/transfer-service.aspx) to issue the Turn On and transfer balance, billing, or payment options as needed.
...
<guidedStep stepNumber={8} section="merc-mgu" headingLevel="h4" />
...
* Use [Add Order Transfer (Manual Transfer)](/OLEV2/Pages/transfer-service.aspx), or
* Use [Direct Transfer a Finalled Contract Balance](/OLEV2/Pages/direct-transfer-a-finalled-contract-balance.aspx) if a final balance must be transferred.

<guidedStep stepNumber={9} section="merc-mgu" headingLevel="h4" />
...
* If message `#200 The task could not be completed. Contact technical support.` displays, refer to [PDD/PPD Payment Arrangement Error Workaround](/OLEV2/_layouts/15/WopiFrame.aspx?sourcedoc=/sites/OLE/OLEV2/Lists/Integrys%20Bulletins/Attachments/565/PDD-PPD%20Payment%20Arrangement%20Error.docx\&action=default).

<guidedStep stepNumber={10} section="merc-mgu" headingLevel="h4" />

Update billing and rate options.

* Accounts with a deposit: refer to [Deposit Refund Criteria](/OLEV2/Pages/Deposit-Refund-Criteria.aspx).
* Current billing options:
  * [Budget Billing](/OLEV2/Pages/Budget-Billing-Processes.aspx)
  * [Change or Modify Automatic Payment Plan](/OLEV2/Pages/Change-an-Automatic-Payment-Plan-Application.aspx)
  * [Paper-Free Billing](/OLEV2/Pages/Paper-Free-Billing.aspx)

### PGL/NSG

<guidedStep stepNumber={1} section="pgl-nsg" headingLevel="h4" />

Access the account.

1. [Locate a Contract](./locate-a-contract.md).
2. If the property is in foreclosure or there is mention of a Sheriff's Sale, refer to [Foreclosure Information](/OLEV2/Pages/foreclosure-information.aspx).
...
<guidedStep stepNumber={2} section="pgl-nsg" headingLevel="h4" />

View and update customer information.

1. Select the Attributes tab and verify identification currently on file. Update if needed. Refer to [Verification Guidelines](/OLEV2/Pages/verification-guidelines.aspx).
2. Select the Contact Methods tab and verify the phone number currently on file. Update if needed. Refer to [Modify Customer Information](/OLEV2/Pages/modify-customer-information.aspx).

<guidedStep stepNumber={3} section="pgl-nsg" headingLevel="h4" />

Determine whether there is an owner agreement at the premise.

1. Locate an owner agreement from the contract.
2. If an owner agreement exists:
   * Make note of the rule. Refer to [Owner Agreement Rules](/OLEV2/Pages/owner-agreement-rules.aspx).
...
<guidedStep stepNumber={4} section="pgl-nsg" headingLevel="h4" />
...
* If No and the owner may be selling the property:
  * [Delete an Owner Agreement](/OLEV2/Pages/Delete-an-Owner-Agreement.aspx).
...
<guidedStep stepNumber={5} section="pgl-nsg" headingLevel="h4" />
...
<guidedStep stepNumber={6} section="pgl-nsg" headingLevel="h4" />
...
<guidedStep stepNumber={7} section="pgl-nsg" headingLevel="h4" />
...
1. If Living Quarters Attached is No and Premise Type is not one of the restricted types, proceed to [Step 8](#pgl-nsg-step-8).
2. If Living Quarters Attached is Yes and Premise Type is restricted:
   ...
   * [Add an Immediate Work Item](/OLEV2/Pages/Add-an-Immediate-Work-Item.aspx):
   ...
   * Enter the customer's final bill address. Refer to [Add a Mailing Address](/OLEV2/Pages/add-a-mailing-address.aspx).
   * [Divert a Bill](/OLEV2/Pages/divert-a-bill.aspx): Type Permanent.
   * Proceed to [Step 12](#pgl-nsg-step-12).

<guidedStep stepNumber={8} section="pgl-nsg" headingLevel="h4" />
...
1. If on Summary Billing:
   * [Delete a Contract from a Summary Bill Contract](/OLEV2/Pages/Delete-a-Contract-from-a-Summary-Bill-Contract.aspx).
...
1. Proceed to [Step 9](#pgl-nsg-step-9).

<guidedStep stepNumber={9} section="pgl-nsg" headingLevel="h4" />
...
<guidedStep stepNumber={10} section="pgl-nsg" headingLevel="h4" />
...
2. If confirmed, refer to [Backdated Turn Off or Turn On](/OLEV2/Pages/Backdated-Turn-On-or-Turn-Off.aspx).
3. If not confirmed, contact a leader or Escalations to verify meter status and determine turn off date.
4. If still not confirmed, proceed to [Escalated Calls](/OLEV2/Pages/Escalated-Calls.aspx).

<guidedStep stepNumber={11} section="pgl-nsg" headingLevel="h4" />
...
1. Make note of the meter location in the informational message.
2. If message `#10471 - The current contract has a pledge...` displays, make note that the pledge must be ended on the current contract if the customer wants it continued on the new contract.
3. Confirm Order Category and Order Type are Turn On/Off and Turn Off.
...
5. On the Scheduling tab:
   * Enter the requested Turn Off date.
   * If backdated, refer to [Backdated Turn Off or Turn On](/OLEV2/Pages/Backdated-Turn-On-or-Turn-Off.aspx).
   * If Completion Method defaults to Auto Complete, determine [Soft Close](/OLEV2/Pages/soft-close.aspx) eligibility.
...
6. Schedule the order if needed.
7. Update the Contact tab:
   * Requested By
   * Contact Phone
...
1. If a field visit is involved and access is needed, advise:
...
2. If a field visit is involved and access is not needed, advise:
...
3. If field work is not involved, advise: "A service person will not visit your premises to complete this request."
...
1. Include as applicable:
   ...
   * Meter number if the number on Services or Contract Overview does not start with P or N. Refer to [View Associated Device](/OLEV2/Pages/View-and-Associate-Devices.aspx).
   * Note if the customer needs a Spanish-speaking technician
   * Additional information
2. Update Order Attributes as applicable:
...
4. Verify the order:
   * Wanted date
   * Complete address with city or town
5. If the customer needs a Turn On at another address that has not been issued, use [Transfer from Turn Off/On](/OLEV2/Pages/transfer-service.aspx).
6. Select OK.
...
<guidedStep stepNumber={12} section="pgl-nsg" headingLevel="h4" />

Determine whether the account is on an active payment arrangement.

1. [View a Payment Arrangement](/OLEV2/Pages/view-a-payment-arrangement.aspx).
...
<guidedStep stepNumber={13} section="pgl-nsg" headingLevel="h4" />
...
* If No:
  * [Cancel a Payment Arrangement](/OLEV2/Pages/cancel-a-payment-arrangement.aspx).
...
<guidedStep stepNumber={14} section="pgl-nsg" headingLevel="h4" />

End Share the Warmth pledge if needed.

1. [Remove a Pledge](/OLEV2/Pages/remove-a-pledge.aspx).
...
<guidedStep stepNumber={15} section="pgl-nsg" headingLevel="h4" />

Ask whether the customer plans to reconnect service at the premise.

* If Yes, advise the customer of the [seasonal reconnection fees](/OLEV2/Pages/Charges-for-Specific-Services.aspx) and policy.
...
<guidedStep stepNumber={1} section="we-wps-comm" headingLevel="h5" />

Access the account and determine whether special account handling applies.

1. [Locate a Contract](./locate-a-contract.md).
2. Verify the caller is authorized. Refer to [Verification Guidelines](/OLEV2/Pages/verification-guidelines.aspx).
3. Update contact information, including e-mail address. Refer to [Telephone Number and E-mail Verification](/OLEV2/Pages/Telephone-Number-and-E-mail-Verification.aspx).
...
1. Verify whether the account is Large Demand or Interruptible.

> Note: Large Demand Contract Type is Large Commercial/Industrial.

1. If Gas Transport:
   * WE only: Small Center transfers to [Large Business Center](/OLEV2/Pages/Business-Solution-Center-\(BSC\).aspx).
   ...
   * WPS only: Fill out the [WPS Gas Transportation template](https://teams.wecenergygroup.com/Depts/CSO_CS/CCC/GB%20Business%20Solutions%20Center/WPS%20References/Gas%20Transport/WPS%20Gas%20Transportation%20%E2%80%93%20Interruptible%20TF-TN-Entity%20Name%20Change%20Template.doc?d=w8c0d9b5ee67a45afa63aade43ae5b410) and send e-mail to [LargeElecGasCustomer@wecenergygroup.com](mailto\:LargeElecGasCustomer@wecenergygroup.com) and [gtsenrollments@spmail.wecenergygroup.com](mailto\:gtsenrollments@spmail.wecenergygroup.com) with Turn Off information.
   * Exit the procedure.
2. If Large Demand or Interruptible:
   * WE only: Small Business Center transfers to Large Business Center.
   * WE only: Large Business Center issues the Turn Off with Completion Method Do Not Dispatch, completes the [Large Commercial/Industrial template](/OLEV2/Documents/Large%20Commercial%20-%20Industrial%20TN-TF%20template%20Electric%20-%20Sales%20Gas%20-%20CoGeneration.docm), attaches it to a note, and [adds an Immediate Work Item](/OLEV2/Pages/Add-an-Immediate-Work-Item.aspx) to Billing-NonRes-General.
   ...
   * Exit the procedure.
3. If WPS Seasonal Opportunity Sales (SOS) rate applies, send e-mail to [LargeElecGasCustomer@wecenergygroup.com](mailto\:LargeElecGasCustomer@wecenergygroup.com) after issuing the Turn Off order to ensure the account bills, then proceed to [Step 2](#we-wps-comm-step-2).
4. If none of the above applies, proceed to [Step 2](#we-wps-comm-step-2).

<guidedStep stepNumber={2} section="we-wps-comm" headingLevel="h5" />

Consider special-handling items.

* If the property is in foreclosure, refer to [Foreclosure Information](/OLEV2/Pages/foreclosure-information.aspx).
* If the account is on [Summary Billing](/OLEV2/Pages/Summary-Billing.aspx), remove member contracts from the group and update the mailing address in Quick Launch during the Turn Off order.
* If the request is for yard light service, refer to [Residential and Commercial Light Turn Off](/OLEV2/Pages/Residential-and-Commercial-Light-Turn-Off.aspx).

<guidedStep stepNumber={3} section="we-wps-comm" headingLevel="h5" />
...
3. If the requester is a renter and an owner agreement exists:
   ...
   * If the information is correct, check [Owner Agreement Rules](/OLEV2/Pages/owner-agreement-rules.aspx).
...
<guidedStep stepNumber={4} section="we-wps-comm" headingLevel="h5" />
...
2. If the information is provided:
   ...
   * [Add or Update Landlord Information](/OLEV2/Pages/Add-or-Update-Landlord-Information.aspx).
   * WE only: Proceed to [Step 5](#we-wps-comm-step-5).
   * WPS only: Proceed to [Step 6](#we-wps-comm-step-6).
3. If the information is not provided:
   * Add a [Premise Note](/OLEV2/Pages/add-a-note.aspx) documenting that the new owner is unknown.
   * WE only: Proceed to [Step 5](#we-wps-comm-step-5).
   * WPS only: Proceed to [Step 6](#we-wps-comm-step-6).

<guidedStep stepNumber={5} section="we-wps-comm" headingLevel="h5" />
...
5. If Living Quarters Attached is Yes and Premise Type is restricted, refer the customer to [Large Business Center](/OLEV2/Pages/Business-Solution-Center-\(BSC\).aspx) and exit.

<guidedStep stepNumber={6} section="we-wps-comm" headingLevel="h5" />
...
* If the Turn On is within 2 days of the requested Turn Off date:
  ...
  * AMR/AMI meter only: if the customer does not agree to the Turn On date, add a Billing Error contract note and an [Add a Note Follow-up](/OLEV2/Pages/Add-a-Note-Follow-up.aspx)) to Billing-Res-General for a backdated Turn On/Off review.
...
<guidedStep stepNumber={7} section="we-wps-comm" headingLevel="h5" />
...
* If seal or lock is requested:
  ...
  * Add a note with [Seal Meter Documentation](/OLEV2/Pages/seal-meter-documentation.aspx).
  * Check Permanent.
  * Proceed to [Step 8](#we-wps-comm-step-8).
* If seal or lock is not requested:
  ...
  * If yes and a Turn On into the landlord's name is within five calendar days:
    * WE non-RSS: [Cancel an Order](/OLEV2/Pages/Cancel-an-Order.aspx) if status is not Arrived.
...
* If the meter is locked due to structure fire:
  ...
  * WPS only: contact [local office](/OLEV2/Pages/miscellaneous-contacts-list.aspx).
  * WE only: contact support.
  * If confirmed, refer to [Backdated Turn On or Turn Off](/OLEV2/Pages/Backdated-Turn-On-or-Turn-Off.aspx).
...
<guidedStep stepNumber={8} section="we-wps-comm" headingLevel="h5" />
...
1. If backdated, refer to [Backdated Turn On or Turn Off](/OLEV2/Pages/Backdated-Turn-On-or-Turn-Off.aspx).
2. Let Completion Method default.
   * If already sealed in the field, select Complete Now Without Dispatch and enter the no-dispatch instruction.
   * WE only: default is Normal Completion if accessible or Appointment if inaccessible. Use [Meter Locations](/OLEV2/Pages/Meter-Locations.aspx) to determine location.
...
> Note: Refer to [Seal Meter Documentation](/OLEV2/Pages/seal-meter-documentation.aspx) when locking or sealing.

1. Update Order Attributes as applicable:
   * Advised of Reconnection Charges
   * Premise Occupied
   * Premise Winterized
2. Use Quick Launch to add a mailing address and update payment arrangements or contact information.
3. Verify the order.
4. If a Turn On still needs to be issued, use [Transfer from Turn Off/On window](/OLEV2/Pages/transfer-service.aspx).
5. If sealing a meter, verify Lock and selected service.
6. Select OK.
...
1. WPS only: if an owner agreement was removed as part of Step 3, add the owner agreement back to the account or [add premise back to the owner agreement](/OLEV2/Pages/add-an-owner-agreement-premise.aspx), cancel the owner-agreement letter, and document why it was cancelled.

<guidedStep stepNumber={9} section="we-wps-comm" headingLevel="h5" />
...
* Use [Add Order Transfer (Manual Transfer)](/OLEV2/Pages/transfer-service.aspx), or
* Use [Direct Transfer a Finalled Contract Balance](/OLEV2/Pages/direct-transfer-a-finalled-contract-balance.aspx).

<guidedStep stepNumber={10} section="we-wps-comm" headingLevel="h5" />

Add a payment arrangement if the customer is in arrears and is not transferring service.

* Include pending payments in the arrangement. Refer to [Finalled Service Account Payment Guidelines](/OLEV2/Pages/Finalled-Service-Account-Payment-Arrangement-Guidelines.aspx).
* If message `#200 The task could not be completed. Contact technical support.` displays, refer to [PDD/PPD Payment Arrangement Error Workaround](/OLEV2/_layouts/15/WopiFrame.aspx?sourcedoc=/sites/OLE/OLEV2/Lists/Integrys%20Bulletins/Attachments/565/PDD-PPD%20Payment%20Arrangement%20Error.docx\&action=default).

<guidedStep stepNumber={11} section="we-wps-comm" headingLevel="h5" />
...
* WPS current rate options:
  * NatureWise removal
  * [Response Rewards Removal Form](/OLEV2/Pages/response-rewards-sign-up-or-removal-.aspx)
  * [Three-Tier-of-Use Removal](/OLEV2/Pages/Three-Tier-Time-of-Use-Sign-Up-or-Removal-.aspx)
...
* If the account has Active Yard Light, refer to [Residential and Commercial Light Turn Off](/OLEV2/Pages/Residential-and-Commercial-Light-Turn-Off.aspx).
* For [Michigan Customer Choice (Michigan Retail Access)](/OLEV2/Pages/Michigan-Choice-Alternate-Electric-Supplier-\(AES\).aspx), advise the customer they will be removed at the current address and may re-enroll at the new address through an AES.

<guidedStep stepNumber={12} section="we-wps-comm" headingLevel="h5" />

WE gas rotary meters only: refer to Billing.

1. Complete the [Large Commercial/Industrial template](/OLEV2/Documents/Large%20Commercial%20-%20Industrial%20TN-TF%20template%20Electric%20-%20Sales%20Gas%20-%20CoGeneration.docm).
2. [Attach an Image in Open-cIS](/OLEV2/Pages/Attach-an-Image-in-Open-cIS.aspx) to a note.
3. [Add an Immediate Work Item](/OLEV2/Pages/Add-an-Immediate-Work-Item.aspx):
...
<guidedStep stepNumber={13} section="we-wps-comm" headingLevel="h5" />
...
<guidedStep stepNumber={14} section="we-wps-comm" headingLevel="h5" />
...
3. If contact is made:
   * Follow the [Turn On](/OLEV2/Pages/Commercial-or-Agricultural-Turn%20On-WE-WPS.aspx) process to bill the new responsible party.

> Note: The Turn On and Turn Off Wanted Date must match to avoid RSS disconnection.

1. If unable to contact the new responsible party:
...
<guidedStep stepNumber={15} section="we-wps-comm" headingLevel="h5" />
...
3. If no Turn On order exists and electric service is finalled:
   ...
   * Use [Assessors by Taxing District](/OLEV2/Pages/Assessors-by-Taxing-District.aspx) and [Land Records Phone and Websites](/OLEV2/Pages/Land-Records-Phone-and-Websites.aspx) when needed.
   * Follow [Backdated Turn On](/OLEV2/Pages/Backdated-Turn-On-or-Turn-Off.aspx) if able to contact the new responsible party.
...
<guidedStep stepNumber={1} section="we-wps-res" headingLevel="h5" />
...
5. If Commercial, transfer to [Business Center](/OLEV2/Pages/Business-Solution-Center-\(BSC\).aspx) during business hours and exit.
6. If Farm:
   * WE only: transfer to [Large Business Center](/OLEV2/Pages/Business-Solution-Center-\(BSC\).aspx) during business hours.
   * WPS only: transfer to Business Center during business hours.
   * Exit.

<guidedStep stepNumber={2} section="we-wps-res" headingLevel="h5" />

Consider special handling items.

* If the property is in foreclosure, refer to [Foreclosure Information](/OLEV2/Pages/foreclosure-information.aspx).
* If on [Summary Billing](/OLEV2/Pages/Summary-Billing.aspx), remove member contracts and update mailing address via Quick Launch during the Turn Off order.
* If the request is for yard light service, refer to [Residential and Commercial Light Turn Off](/OLEV2/Pages/Residential-and-Commercial-Light-Turn-Off.aspx).

<guidedStep stepNumber={3} section="we-wps-res" headingLevel="h5" />
...
3. If an owner agreement exists:
   ...
   * If the requester is a renter, ask who they are renting from.
   * If the information is correct, check [Owner Agreement Rules](/OLEV2/Pages/owner-agreement-rules.aspx) to verify whether landlord contact is required, then proceed to [Step 5](#we-wps-res-step-5).
...
<guidedStep stepNumber={4} section="we-wps-res" headingLevel="h5" />

Determine who is or will be responsible for service.

1. Ask for landlord, realtor, or new owner information, including phone number.
2. [Add or Update Landlord Information](/OLEV2/Pages/Add-or-Update-Landlord-Information.aspx) to document it.

<guidedStep stepNumber={5} section="we-wps-res" headingLevel="h5" />
...
<guidedStep stepNumber={6} section="we-wps-res" headingLevel="h5" />
...
* November 1 to April 15:
  ...
  * Discuss [Seal Meter Precautions and Rules](/OLEV2/Pages/Seal-Meter-Documentation.aspx).
...
<guidedStep stepNumber={7} section="we-wps-res" headingLevel="h5" />
...
5. Let Completion Method default.
   * If already sealed in the field, select Complete Now Without Dispatch and enter the no-dispatch instruction.
   * WE only: use [Meter Locations](/OLEV2/Pages/Meter-Locations.aspx) to determine accessibility and choose Normal Completion or Appointment accordingly.
...
<guidedStep stepNumber={8} section="we-wps-res" headingLevel="h5" />

Transfer balances or payment options if needed.

If they were not transferred during the Turn Off and a same-customer Turn On exists in progress or pending, use [Add Order Transfer (Manual Transfer)](/OLEV2/Pages/transfer-service.aspx) or [Direct Transfer a Finalled Contract Balance](/OLEV2/Pages/direct-transfer-a-finalled-contract-balance.aspx).

<guidedStep stepNumber={9} section="we-wps-res" headingLevel="h5" />

Add a payment arrangement when needed.

* Include pending payments.
* Refer to [Finalled Service Account Payment Guidelines](/OLEV2/Pages/Finalled-Service-Account-Payment-Arrangement-Guidelines.aspx).
* If `#200` displays, refer to [PDD/PPD Payment Arrangement Error Workaround](/OLEV2/_layouts/15/WopiFrame.aspx?sourcedoc=/sites/OLE/OLEV2/Lists/Integrys%20Bulletins/Attachments/565/PDD-PPD%20Payment%20Arrangement%20Error.docx\&action=default).
* If enrolled in a LIFT payment arrangement, advise the customer the contract must final first and then they must contact [Credit Call Handling](/OLEV2/Pages/Credit-Call-Handling.aspx) to determine eligibility at the new premise.

<guidedStep stepNumber={10} section="we-wps-res" headingLevel="h5" />
...
* If there is an Active Yard Light, refer to [Residential and Commercial Light Turn Off](/OLEV2/Pages/Residential-and-Commercial-Light-Turn-Off.aspx).
* For [Michigan Customer Choice (Michigan Retail Access)](/OLEV2/Pages/Michigan-Choice-Alternate-Electric-Supplier-\(AES\).aspx), advise the customer they will be removed from the program at the current address and may re-enroll at the new address through an AES.
...
* [Demolition PGL or NSG](/OLEV2/Pages/demolition-pgl-nsg.aspx)
* [Handle Multiple Accounts](/OLEV2/Pages/handle-multiple-accounts.aspx)
* [Order Category and Type PGL NSG](/OLEV2/Pages/Order-Category-and-Type-PGL-NSG.aspx)
