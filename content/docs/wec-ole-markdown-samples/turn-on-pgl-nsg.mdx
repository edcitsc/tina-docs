...
last_edited: '2026-06-15T20:27:28.678Z'
...
1. [Locate a Premise](/docs/wec-ole-markdown-samples/locate-a-premise).
...
4. Verify whether the account is on Large Volume Gas Transportation (LVGT).
...
1. Proceed to Step 5.
2. If gas is off at meter, b-box, riser, or the meter is removed, proceed to Step 4.
3. If gas is off at the main, or PGL only with no service pipe:
...
1. Ask the customer the following:
...
2. Determine whether the offering is correct based on the customer's response.
...
1. Update Contact Methods. Refer to [Telephone Number and E-mail Verification](https://ole.wecenergygroup.com/sites/OLE/OLEV2/Pages/Telephone-Number-and-E-mail-Verification.aspx).
...
2. Make note of any past due or charge-off balances the customer owes and the contract numbers, which are the customer number plus sequence number.
3. Proceed to Step 7.
4. If the customer is not located, proceed to Step 7.
...
2. Select the appropriate option from the Contract Type drop-down list.
...
1. On the Services tab, select the Gas Service Type checkbox.
...
2. Enter the following in the Wanted Date field:
...
1. Select Meter Set/Install from the Install Gas Meter Work Type attribute drop-down list when necessary.
2. Schedule the order if necessary.
...
3. Advise the customer as follows when a field visit is involved and access is needed:
   * English:
...
2. Select the Charges tab and advise the customer of the charge.
...
1. Select the Owner Agreement History tab and determine whether the contract has an owner agreement.
   ...
   * Refer to Step 19.
2. Select the Premise Contacts tab to view and update landlord information. Refer to [Add or Update Landlord Information](https://ole.wecenergygroup.com/sites/OLE/OLEV2/Pages/Add-or-Update-Landlord-Information.aspx).
3. Repeat the address and city or town back to the customer to verify the order is created for the correct address.
4. Select OK.
